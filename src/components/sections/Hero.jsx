...
const Hero = ({ splashDone = true }) => {
    ...
    if (loading) {
        return (
            <section id="hero" className="relative flex items-center justify-center min-h-[60vh] lg:min-h-[65vh] pt-[60px] md:pt-[70px] pb-8 lg:pb-6 overflow-hidden bg-transparent">
    ...
    return (
        <section
            id="hero"
            ref={sectionRef}
            className="relative flex items-start lg:items-center min-h-[60vh] lg:min-h-[65vh] pt-[60px] md:pt-[70px] pb-8 lg:pb-6 overflow-hidden bg-transparent"
        >
