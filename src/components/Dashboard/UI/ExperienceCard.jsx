...
const ExperienceCard = ({ experience, onEdit, onDelete, onMoveUp, onMoveDown, isFirst, isLast, previewMode = false }) => {
  ...
  return (
    <div className={`bg-[#0f172a] rounded-[16px] border border-[#1e293b] p-6 shadow-sm hover:shadow-xl hover:border-[#334155] transition-all duration-300 flex flex-col h-full group relative overflow-hidden ${!previewMode && 'hover:-translate-y-0.5'}`}>
      
      {/* Numbering (Phase Indicator) */}
      <div className="mb-4">
        <span className="text-[11px] font-mono font-bold uppercase tracking-[0.2em] text-[#14f195]/80">
          {String(experience.order || '0').padStart(2, '0')} / PHASE
        </span>
      </div>
      ...
      <div className="flex-grow flex flex-col">
        ...
        {tags.length > 0 && (
          <div className="mt-auto mb-6">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-3">
              Technologies
            </h4>
      ...
      {/* Actions - hide if in preview mode */}
      {!previewMode && (
