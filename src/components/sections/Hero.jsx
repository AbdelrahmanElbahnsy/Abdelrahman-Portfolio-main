...
const Hero = ({ splashDone = true }) => {
    ...
    if (loading) {
        return (
            <section id="hero" className="relative flex items-center justify-center min-h-[70vh] lg:min-h-[75vh] pt-[75px] md:pt-[85px] pb-12 lg:pb-10 overflow-hidden bg-transparent">
    ...
    return (
        <section
            id="hero"
            ref={sectionRef}
            className="relative flex items-start lg:items-center min-h-[70vh] lg:min-h-[75vh] pt-[75px] md:pt-[85px] pb-12 lg:pb-10 overflow-hidden bg-transparent"
        >
            <div className="container px-6 sm:px-8 mx-auto h-full flex flex-col justify-start lg:justify-center">
                <div className="grid items-center grid-cols-1 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] gap-8 md:gap-12 lg:gap-[clamp(2rem,5vw,5rem)] hero-grid w-full max-w-full min-w-0" dir="ltr">
                    <div className="hero-left flex flex-col justify-center min-w-0 w-full" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                        ...
                        <h1
                            ref={nameRef}
                            className="hero-name text-[clamp(1.35rem,7.2vw,2.8rem)] md:text-[clamp(2rem,8vw,3.5rem)] whitespace-nowrap font-black mb-3 md:mb-5 leading-[1.05] tracking-tight text-left rtl:text-right"
