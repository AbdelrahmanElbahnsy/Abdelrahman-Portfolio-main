        ...
        <section id="certifications" className="section bg-transparent relative overflow-hidden" ref={sectionRef}>
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="w-full relative px-4 sm:px-0 min-h-[400px] flex items-center justify-center">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center text-[var(--theme-accent)] w-full">
                            <i className="fas fa-spinner fa-spin text-4xl mb-4"></i>
                            <p>{t('Loading certifications...')}</p>
                        </div>
                    ) : error ? (
                        <div className="flex flex-col items-center justify-center text-red-500 bg-red-500/10 p-6 rounded-2xl border border-red-500/20 w-full">
                            <i className="fas fa-exclamation-triangle text-3xl mb-3"></i>
                            <p>{t('Failed to load certifications')}</p>
                            <p className="text-sm opacity-80 mt-2">{error}</p>
                        </div>
                    ) : certifications.length === 0 ? (
                        <div className="flex flex-col items-center justify-center text-[var(--theme-text-muted)] bg-[var(--theme-surface)] p-8 rounded-3xl border border-[var(--theme-border)] shadow-inner w-full">
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            {/* Navigation Controls */}
                            <div className="flex items-center justify-center gap-4 md:gap-8 mt-4 relative z-20 w-full">
