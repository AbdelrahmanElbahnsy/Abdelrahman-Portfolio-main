...
import { Bell, CheckCircle, AlertTriangle, AlertCircle, Info, X, Trash2 } from 'lucide-react';
...
const NotificationCenter = () => {
  ...
  }, [isOpen, visibleNotifications.length]);
      ...
      <AnimatePresence>
        {isOpen && createPortal(
          <>
            ...
            >
              <div className="flex items-center justify-between p-3 border-b border-cms-border bg-white/[0.02]">
                ...
                {visibleNotifications.length > 0 && activeNotifications.length > 0 && (
                  <button 
                    onClick={markAllAsRead}
                    className="text-xs text-cms-primary hover:text-cms-primary/80 transition-colors"
                  >
                    Mark all read
                  </button>
                )}
